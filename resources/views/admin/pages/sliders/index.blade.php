...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-body">
        ...
        <!--slider modal-->
        <a href="{{route('admin.slider.create',$slider->id)}}" class="btn btn-info float-right mb-2">
        ...
        <!--foem end -->
          <table class="table table-hover table-striped">
            ...
            <tr>
              ...
              <td>{{ $slider->title }}</td>
              <td>
                <img src="{{ asset('images/sliders/'.$slider->images) }}" width="40">
              </td>
              <td>{{ $slider->priority }}</td>
              <td>
                <!--a href="{{route('admin.slider.update',$slider->id)}}" class="btn btn-success">Edit</a>
