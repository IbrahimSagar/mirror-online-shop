  ...
  <div class="col-md-6">
    <div class="checkoutForm">
      <form class="form-group" role="form" id="" method="post" action="{{ url('/') }}/confirm-order">
        ...
        <input type="Email" placeholder="abc@example.com" class="form-control input" 
        @if(Auth::check()) value="{{Auth::user()->email}}" @endif name="customer_email" required>
        ...
        <button class="button btn-info"  style="margin: 10px 0px 0px 230px"><i class="icon-login"></i>&nbsp; <span>Submit</span>
        </button>
        </form>  
      </div>
    </div>
